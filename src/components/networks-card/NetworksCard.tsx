...
export default function NetworksCard() {
  return (
    <div className="bg-white flex flex-row items-center justify-center gap-10 flex-grow w-full rounded-[25px] h-[173px] absolute z-20 bottom-0 lg:bottom-0 lg:gap-16">
